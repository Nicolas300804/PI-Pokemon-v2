...
const Paginado =({pokemonPerPage, pokemons, paginado})=>{ // Me traigo el estado PokemonsPerPage, la constante que me muestra todos los pokemon y la constante paginado del componente Home
    ...
    for (let i = 0; i <= Math.ceil(pokemons/pokemonPerPage); i++) { //recorro un arreglo en el que tomo un numero redondo que resulta de dividir todos los personajes por los personajes por pagina que yo quiero 

        pageNumbers.push(i+1) //pusheo todo en mi arreglo de Page numbers
    }
    return(
